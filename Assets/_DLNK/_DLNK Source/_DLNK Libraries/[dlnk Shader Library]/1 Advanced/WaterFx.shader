...
Shader "DLNK Shaders/Advanced/WaterFx" {
    ...
    SubShader {
        ...
        Pass {
            ...
            #pragma exclude_renderers metal d3d11_9x xbox360 xboxone ps4 
            #pragma target 3.0
